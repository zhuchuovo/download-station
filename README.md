...
```bash
sudo apt update && sudo apt install -y git nodejs npm postgresql && git clone https://github.com/zhuchuovo/download-station.git && cd download-station && sudo node server/panel.js
```
